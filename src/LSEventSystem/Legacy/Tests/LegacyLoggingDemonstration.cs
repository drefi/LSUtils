...
namespace LSUtils.Tests {
    [TestFixture]
    public class LegacyLoggingDemonstration {
        
        // Test events for demonstration
        private class DemoUserRegistrationEvent : LSLegacyEvent<DemoUser> {
        ...
        private class DemoSystemStartupEvent : LSLegacyBaseEvent {
