...
/// </summary>
internal class LSLegacyHandlerRegistration {
    /// <summary>
    ...
    /// </summary>
    public required Func<ILSEvent, LSLegacyPhaseContext, LSHandlerResult> Handler { get; set; }
    
    /// <summary>
    /// The phase in which this handler should execute.
    /// </summary>
    public LSLegacyEventPhase Phase { get; set; }
    
    /// <summary>
    /// The execution priority within the phase.
    /// </summary>
    public LSPriority Priority { get; set; }
