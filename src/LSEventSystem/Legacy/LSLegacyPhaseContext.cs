...
/// </summary>
public class LSLegacyPhaseContext {
    /// <summary>
    /// The current phase being executed.
    /// </summary>
    public LSLegacyEventPhase CurrentPhase { get; }
    ...
    internal LSLegacyPhaseContext(LSLegacyEventPhase phase, LSPriority priority, TimeSpan elapsed, int executed, List<string> errors) {
        CurrentPhase = phase;
        Priority = priority;
        ElapsedTime = elapsed;
