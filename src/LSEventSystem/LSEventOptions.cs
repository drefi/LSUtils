...
public class LSEventOptions {
    ...
    /// </summary>
    public LSDispatcher Dispatcher { get; set; } = LSDispatcher.Singleton;
    ...
    /// <returns>This instance for method chaining.</returns>
    public LSEventOptions WithOwnerInstance(object? ownerInstance) {
        OwnerInstance = ownerInstance;
        return this;
    }
    ...
    /// <returns>This instance for method chaining.</returns>
    public LSEventOptions WithSuccessCallback(LSAction<ILSEvent>? callback) {
    ...
    /// <param name="callback">The callback to add.</param>
    /// <returns>This instance for method chaining.</returns>
    public LSEventOptions WithFailureCallback(LSAction<ILSEvent>? callback) {
    ...
    /// <param name="callback">The callback to add.</param>
    /// <returns>This instance for method chaining.</returns>
    public LSEventOptions WithCancelCallback(LSAction<ILSEvent>? callback) {
    ...
    /// <param name="callback">The callback to add.</param>
    /// <returns>This instance for method chaining.</returns>
    public LSEventOptions WithCompleteCallback(LSAction<ILSEvent>? callback) {
    ...
    public static TOptions Create<TOptions>(LSDispatcher? dispatcher = null, object? ownerInstance = null)
        where TOptions : LSEventOptions, new() {
        return new TOptions() {
