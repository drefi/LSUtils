...
/// </summary>
internal struct LSPhaseExecutionResult {
    /// <summary>
    ...
    public static LSPhaseExecutionResult Successful() => new() { Success = true };

    /// <summary>
    /// Creates a waiting phase execution result for async operations.
    /// </summary>
    /// <returns>A waiting phase execution result.</returns>
    public static LSPhaseExecutionResult Waiting() => new() { Success = true, ShouldWait = true };
    ...
    public static LSPhaseExecutionResult Cancelled(string? reason = null) => 
    ...
    public static LSPhaseExecutionResult Failed(string? reason = null) => 
