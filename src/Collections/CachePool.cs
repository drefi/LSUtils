    ...
    public class ObjectCachePool<T> : ICachePool<T> where T : class {
        ...
        public T GetInstance() {
            ...
            if (result != null) {
                ...
                return _constructorDelegate?.Invoke() ?? throw new System.InvalidOperationException("No constructor delegate provided and no cached instances available.");
            }
        }
