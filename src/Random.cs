...
public static class ThreadSafeRandom {
    [System.ThreadStatic] private static Random? Local;

    public static Random ThisThreadsRandom {
        get { return Local ?? (Local = new Lehmer.Random(unchecked(System.Environment.TickCount * 31 + System.Environment.CurrentManagedThreadId))); }
    }
}
