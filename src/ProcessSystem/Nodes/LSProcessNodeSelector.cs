...
/// <summary>Editable selector template. Execution state belongs exclusively to the session.</summary>
public class LSProcessNodeSelector : ILSProcessLayerNode {
    ...
    public ILSProcessLayerNode Clone() {
        var clone = new LSProcessNodeSelector(NodeID, Order, Priority, UpdatePolicy,
